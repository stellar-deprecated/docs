...
`transaction.route` | string | The route information returned by the receiving federation server. Tells the reciever how to get the transaction to the ultimate recipient. 
