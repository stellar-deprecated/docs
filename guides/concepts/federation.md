...
Supported types:
 ...
 - **forward**: Used for forwarding the payment on to a different network or different financial institution. In this case `q` is a JSON structure that contains the information needed for the other network. Example: `https://YOUR_FEDERATION_SERVER/federation?q=%7B%22bank%22%3A%22BNORPHMM%22%2C%22acct%22%3A%22187663627%22%7D&type=forward`
