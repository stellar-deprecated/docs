...
|Master weight| integer| A number from 0-255 representing the weight of the master key. This account may also add other keys with which to sign transactions using `signer` below.|
